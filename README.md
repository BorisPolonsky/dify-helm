...
graph TB
    ...
    %% Backend Pods
    APIService --> APIPod[📦 API Pod<br/>langgenius/dify-api:1.9.2<br/>Port: 5001]
    WebService --> WebPod[📦 Web Pod<br/>langgenius/dify-web:1.9.2<br/>Port: 3000]
    PluginService --> PluginPod[📦 Plugin Daemon Pod<br/>langgenius/dify-plugin-daemon:0.3.3-local<br/>Ports: 5002, 5003]

    %% Worker Pod (Background Processing)
    WorkerPod[📦 Worker Pod<br/>langgenius/dify-api:1.9.2]

    %% Beat Pod (Periodic task scheduler)
    BeatPod[📦 Beat Pod<br/>langgenius/dify-api:1.9.2]
...
|-----------|-------|------|------|
| **API** | `langgenius/dify-api:1.9.2` | 5001 | RESTful API server, business logic processing |
| **Web** | `langgenius/dify-web:1.9.2` | 3000 | Web UI frontend |
| **Worker** | `langgenius/dify-api:1.9.2` | - | Background task processing (Celery) |
| **Beat** | `langgenius/dify-api:1.9.2` | - | Periodic task scheduler (Celery Beat) |
| **Sandbox** | `langgenius/dify-sandbox:0.2.12` | 8194 | Secure code execution environment |
| **Plugin Daemon** | `langgenius/dify-plugin-daemon:0.3.3-local` | 5002, 5003 | Plugin management and execution |
