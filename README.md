...
|-----------|-------|------|------|
| **API** | `langgenius/dify-api:1.6.0` | 5001 | RESTful API server, business logic processing |
| **Web** | `langgenius/dify-web:1.6.0` | 3000 | Web UI frontend |
| **Worker** | `langgenius/dify-api:1.6.0` | - | Background task processing (Celery) |
